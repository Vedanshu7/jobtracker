...
function fetchAndDisplayData() {
    // Fetch the API data
    fetch("https://localhost:7100/User?userId=76848a5d-1b02-4fbd-954a-0b505bb46f85")
      ...
      var content = `
        <div class="row g-4">
          ...
          <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
            ...
            <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i>Date Line: ${job.updatedDate}</small>
          </div>
        </div>
      `;
